...
from models import refgoog_baseline_model
...
im_mean = refgoog_baseline_model.fastrcnn_vgg_net.channel_mean

# Snapshot Params
snapshot_file = './downloaded_models/refgoog_baseline_iter_300000.tfmodel'

output_file = './exp-refgoog/results/refgoog_baseline_iter_300000_val.txt'
...
# Outputs
scores = refgoog_baseline_model.refgoog_baseline_net(im_batch, bbox_batch,
