...
def vgg_fc8(input_batch, name, apply_dropout, output_dim=1000, reuse=None):
    fc7 = vgg_fc7(input_batch, name, apply_dropout, reuse)
    with tf.variable_scope(name, reuse=reuse):
...
def vgg_fc8_full_conv(input_batch, name, apply_dropout, output_dim=1000, reuse=None):
