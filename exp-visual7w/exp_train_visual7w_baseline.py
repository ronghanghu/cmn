...
# Data Params
imdb_file = './exp-visual7w/data/imdb/imdb_trn.npy'
vocab_file = './word_embedding/vocabulary_72700.txt'
im_mean = visual7w_baseline_model.fastrcnn_vgg_net.channel_mean

# Snapshot Params
snapshot_interval = 10000
snapshot_file = './exp-visual7w/tfmodel/visual7w_baseline_iter_%d.tfmodel'

# Log params
log_interval = 20
log_dir = './exp-visual7w/tb/visual7w_baseline/'
