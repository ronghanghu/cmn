...
snapshot_file = './exp-visgeno-rel/tfmodel/visgeno_attbilstm_strong_iter_%d.tfmodel'

# Log params
log_interval = 20
log_dir = './exp-visgeno-rel/tb/visgeno_attbilstm_strong/'
...
scores_flat = tf.reshape(scores, tf.convert_to_tensor([N_lang, N_bbox*N_bbox]))
