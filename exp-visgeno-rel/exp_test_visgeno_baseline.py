...
# Snapshot Params
model_file = './downloaded_models/visgeno_baseline_iter_360000.tfmodel'

result_file = './exp-visgeno-rel/results/visgeno_baseline_iter_360000_tst.txt'
...
for n_iter in range(reader.num_batch):
    ...
    N_batch, N_box, _ = scores_val.shape

    # scores_val has shape [N_batch, N_box, N_box, 1]
    scores_obj1 = scores_val.reshape((N_batch, N_box))
