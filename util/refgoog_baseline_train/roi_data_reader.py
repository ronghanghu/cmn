...
from util.refgoog_baseline_train.prepare_batch import load_one_batch

def run_prefetch(prefetch_queue, roidb, im_mean, min_size, max_size, vocab_dict,
    T, num_batch, shuffle):
...
class DataReader:
    def __init__(self, roidb_file, vocab_file, im_mean, min_size=600,
